...
// Lista de emails autorizados — se carga desde AUTHORIZED_EMAILS en el .env
// Formato: emails separados por coma, sin espacios
...
if (AUTHORIZED_EMAILS.length === 0) {
  console.warn('⚠️  ADVERTENCIA: AUTHORIZED_EMAILS no está configurado en el .env — nadie podrá iniciar sesión.');
}
